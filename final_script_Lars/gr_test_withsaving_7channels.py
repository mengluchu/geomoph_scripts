# =============================================================================
# gr_test-Withsaving with 7 classes
# =============================================================================
import torch
import torchvision
...
EPOCH = 300
reduce = 8
savepath = os.path.join(r'C:\Data\uni\uni\Master\Guided-Research\results\new',"{}_{}_{}_7".format(training_tiles,size,EPOCH))
...
class CNNmodel(pl.LightningModule):
    ...
    def test_dataloader(self):
        return test_loader
#%%load the model
model_path=r"C:\Data\uni\uni\Master\Guided-Research\model_param\new\s_{}_{}-epoch={}.ckpt".format(training_tiles,size,ep_nr)
...
for plot in range(1,nr_tiles+1):
    ...
    plt.subplot(1,4,4)
    try1 = np.moveaxis(x_test0[plot-1,1:4,],0,-1)
