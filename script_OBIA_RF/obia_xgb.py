...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 15 11:22:41 2021
...
# %% [code]
train_frac= 0.8
joind = gp.read_file("/Volumes/Meng_Mac/obia/GMKOBIA.gpkg")
...
# %% [code]
train = Pcl.groupby('group_M').sample(n = 100).index
