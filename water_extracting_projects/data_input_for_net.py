...
if __name__ == '__main__':
    # path = r'E:\zl_datas\ZheJiang_data20200803\water_dataset_processed\aerial_dataset\train-data\img\3435463.tif'
    # img = cv.imread(path, cv.IMREAD_COLOR)
    # tmp_img = img[512:1024, 512:1536, ::-1]
    # hsv_transform = RGBtoHSVTransform()
    # tmp_img = hsv_transform(tmp_img)
    # print(tmp_img.max(), tmp_img.min())
    # plt.imshow(tmp_img)
    # plt.show()
    diff_samples = []
