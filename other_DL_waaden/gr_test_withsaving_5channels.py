# =============================================================================
# gr_test-Withsaving with 5 classes
# =============================================================================
import torch
import torchvision
...
EPOCH = 300
reduce = 8
savepath = os.path.join(r'C:\Data\uni\uni\Master\Guided-Research\results',"{}_{}_{}_5".format(training_tiles,size,EPOCH))
...
class CNNmodel(pl.LightningModule):
    def __init__(self):
        ...
        self.net = smp.Unet(classes=num_class, in_channels=5, activation = 'softmax')
    ...
    def test_dataloader(self):
        return test_loader
#%%load the model
model_path=r"C:\Data\uni\uni\Master\Guided-Research\model_param\s_{}_{}-epoch={}.ckpt".format(training_tiles,size,ep_nr)
new_model = CNNmodel.load_from_checkpoint(checkpoint_path=model_path,
                                         maplocation="gpu")
